            ...
            const podiumEmbed = new EmbedBuilder ()
                ...
                .addFields( // no use <@id> because this bot can cross server (changable)
                    { 
                        ...
                        value: `Games played: ${score[0].gamesPlayed}
                                Average cards Left: ${score[0].cardsLeft.avg}`,
                        inline: false,
                    },
                    { 
                        name: `2nd: ${score[1].username}`,
                        value: `Games played: ${score[1].gamesPlayed}
                              Average cards Left: ${score[1].cardsLeft.avg}`,
                        inline: false,
                    },
                    { 
                        name: `3rd: ${score[2].username}`,
                        value: `Games played: ${score[2].gamesPlayed}
                                Average cards Left: ${score[2].cardsLeft.avg}`,
                        inline: false,
                    },
                )
